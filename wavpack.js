...
var SYSCALLS = {
 ...
 doStat: function(func, path, buf) {
  ...
  LE_HEAP_STORE_I32((buf + 4 >> 2) * 4, stat.mode);
  LE_HEAP_STORE_U32((buf + 8 >> 2) * 4, stat.nlink);
  LE_HEAP_STORE_I32((buf + 12 >> 2) * 4, stat.uid);
  LE_HEAP_STORE_I32((buf + 16 >> 2) * 4, stat.gid);
  LE_HEAP_STORE_I32((buf + 20 >> 2) * 4, stat.rdev);
  tempI64 = [ stat.size >>> 0, (tempDouble = stat.size, +Math.abs(tempDouble) >= 1 ? tempDouble > 0 ? +Math.floor(tempDouble / 4294967296) >>> 0 : ~~+Math.ceil((tempDouble - +(~~tempDouble >>> 0)) / 4294967296) >>> 0 : 0) ], 
  LE_HEAP_STORE_I32((buf + 24 >> 2) * 4, tempI64[0]), LE_HEAP_STORE_I32((buf + 28 >> 2) * 4, tempI64[1]);
  LE_HEAP_STORE_I32((buf + 32 >> 2) * 4, 4096);
  LE_HEAP_STORE_I32((buf + 36 >> 2) * 4, stat.blocks);
  ...
  LE_HEAP_STORE_U32((buf + 48 >> 2) * 4, atime % 1e3 * 1e3);
  tempI64 = [ Math.floor(mtime / 1e3) >>> 0, (tempDouble = Math.floor(mtime / 1e3), 
  +Math.abs(tempDouble) >= 1 ? tempDouble > 0 ? +Math.floor(tempDouble / 4294967296) >>> 0 : ~~+Math.ceil((tempDouble - +(~~tempDouble >>> 0)) / 4294967296) >>> 0 : 0) ], 
  LE_HEAP_STORE_I32((buf + 56 >> 2) * 4, tempI64[0]), LE_HEAP_STORE_I32((buf + 60 >> 2) * 4, tempI64[1]);
  LE_HEAP_STORE_U32((buf + 64 >> 2) * 4, mtime % 1e3 * 1e3);
  tempI64 = [ Math.floor(ctime / 1e3) >>> 0, (tempDouble = Math.floor(ctime / 1e3), 
  +Math.abs(tempDouble) >= 1 ? tempDouble > 0 ? +Math.floor(tempDouble / 4294967296) >>> 0 : ~~+Math.ceil((tempDouble - +(~~tempDouble >>> 0)) / 4294967296) >>> 0 : 0) ], 
  LE_HEAP_STORE_I32((buf + 72 >> 2) * 4, tempI64[0]), LE_HEAP_STORE_I32((buf + 76 >> 2) * 4, tempI64[1]);
  LE_HEAP_STORE_U32((buf + 80 >> 2) * 4, ctime % 1e3 * 1e3);
  tempI64 = [ stat.ino >>> 0, (tempDouble = stat.ino, +Math.abs(tempDouble) >= 1 ? tempDouble > 0 ? +Math.floor(tempDouble / 4294967296) >>> 0 : ~~+Math.ceil((tempDouble - +(~~tempDouble >>> 0)) / 4294967296) >>> 0 : 0) ], 
  LE_HEAP_STORE_I32((buf + 88 >> 2) * 4, tempI64[0]), LE_HEAP_STORE_I32((buf + 92 >> 2) * 4, tempI64[1]);
  return 0;
 },
  ...
  case 21505:
   {
    ...
    if (stream.tty.ops.ioctl_tcgets) {
     ...
     LE_HEAP_STORE_I32((argp >> 2) * 4, termios.c_iflag || 0);
     LE_HEAP_STORE_I32((argp + 4 >> 2) * 4, termios.c_oflag || 0);
     LE_HEAP_STORE_I32((argp + 8 >> 2) * 4, termios.c_cflag || 0);
     LE_HEAP_STORE_I32((argp + 12 >> 2) * 4, termios.c_lflag || 0);
     for (var i = 0; i < 32; i++) {
  ...
  case 21508:
   {
    ...
    if (stream.tty.ops.ioctl_tcsets) {
     var argp = SYSCALLS.get();
     var c_iflag = LE_HEAP_LOAD_I32((argp >> 2) * 4);
     var c_oflag = LE_HEAP_LOAD_I32((argp + 4 >> 2) * 4);
     var c_cflag = LE_HEAP_LOAD_I32((argp + 8 >> 2) * 4);
     var c_lflag = LE_HEAP_LOAD_I32((argp + 12 >> 2) * 4);
     var c_cc = [];
     for (var i = 0; i < 32; i++) {
  ...
  case 21523:
   {
    ...
    if (stream.tty.ops.ioctl_tiocgwinsz) {
     ...
     var argp = SYSCALLS.get();
     LE_HEAP_STORE_I16((argp >> 1) * 2, winsize[0]);
     LE_HEAP_STORE_I16((argp + 2 >> 1) * 2, winsize[1]);
    }
    return 0;
   }
...
var unexportedSymbols = [ "run", "addOnPreRun", "addOnInit", "addOnPreMain", "addOnExit", "addOnPostRun", "addRunDependency", "removeRunDependency", "FS_createFolder", "FS_createPath", "FS_createDataFile", "FS_createLazyFile", "FS_createLink", "FS_createDevice", "FS_unlink", "out", "err", "callMain", "abort", "keepRuntimeAlive", "wasmMemory", "wasmTable", "wasmExports", "stackAlloc", "stackSave", "stackRestore", "getTempRet0", "setTempRet0", "writeStackCookie", "checkStackCookie", "convertI32PairToI53Checked", "ptrToString", "zeroMemory", "exitJS", "getHeapMax", "ENV", "MONTH_DAYS_REGULAR", "MONTH_DAYS_LEAP", "MONTH_DAYS_REGULAR_CUMULATIVE", "MONTH_DAYS_LEAP_CUMULATIVE", "ERRNO_CODES", "ERRNO_MESSAGES", "setErrNo", "DNS", "Protocols", "Sockets", "initRandomFill", "randomFill", "timers", "warnOnce", "UNWIND_CACHE", "readEmAsmArgsArray", "handleException", "asyncLoad", "alignMemory", "mmapAlloc", "getCFunc", "freeTableIndexes", "functionsInTableMap", "setValue", "getValue", "PATH", "PATH_FS", "UTF8Decoder", "UTF8ArrayToString", "UTF8ToString", "stringToUTF8Array", "stringToUTF8", "lengthBytesUTF8", "intArrayFromString", "UTF16Decoder", "stringToUTF8OnStack", "writeArrayToMemory", "JSEvents", "specialHTMLTargets", "currentFullscreenStrategy", "restoreOldWindowedStyle", "demangle", "demangleAll", "ExitStatus", "doReadv", "doWritev", "promiseMap", "uncaughtExceptionCount", "exceptionLast", "exceptionCaught", "Browser", "wget", "SYSCALLS", "preloadPlugins", "FS_createPreloadedFile", "FS_modeStringToFlags", "FS_getMode", "FS_stdin_getChar_buffer", "FS_stdin_getChar", "FS", "MEMFS", "TTY", "PIPEFS", "SOCKFS", "tempFixedLengthArray", "miniTempWebGLFloatBuffers", "miniTempWebGLIntBuffers", "GL", "emscripten_webgl_power_preferences", "AL", "GLUT", "EGL", "GLEW", "IDBStore", "SDL", "SDL_gfx", "GLFW", "allocateUTF8", "allocateUTF8OnStack", "LE_HEAP_STORE_U16", "LE_HEAP_STORE_I16", "LE_HEAP_STORE_U32", "LE_HEAP_STORE_I32", "LE_HEAP_STORE_F32", "LE_HEAP_STORE_F64", "LE_HEAP_LOAD_U16", "LE_HEAP_LOAD_I16", "LE_HEAP_LOAD_U32", "LE_HEAP_LOAD_I32", "LE_HEAP_LOAD_F32", "LE_HEAP_LOAD_F64" ];
